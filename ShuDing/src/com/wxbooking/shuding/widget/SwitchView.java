...
/**
 * http://blog.csdn.net/yan8024/article/details/46817593(源码出自)
 * 
 * @author heshicaihao
 * 
 */
public class SwitchView extends View {
	...
	// 按钮的颜色
	private int btnColor = 0xff4ada60;
	...
	protected void onDraw(Canvas canvas) {
		...
		paint.setColor(isOn ? btnColor : 0xffe3e3e3);
		...
		paint.setColor(isOn ? btnColor : 0xffbfbfbf);
		canvas.drawPath(bPath, paint);
