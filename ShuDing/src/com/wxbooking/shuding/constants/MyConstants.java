package com.wxbooking.shuding.constants;
...
public class MyConstants {
	...
	// 订单搜索 编码
	public static final int ORDER_SEARCH_CODE = 1;
	// 客户搜索 编码
	public static final int CLIENT_SEARCH_CODE = 2;
	// 积分搜索 编码
	public static final int INTEGRAL_SEARCH_CODE = 3;
