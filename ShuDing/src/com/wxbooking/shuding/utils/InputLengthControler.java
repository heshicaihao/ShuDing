...
public class InputLengthControler {
    ...
    private final String hint_remain_count = AppContext.getInstance().getString(R.string.hint_remain_count);
    private final String hint_max_length_msg = AppContext.getInstance().getString(R.string.hint_max_length_msg);;
